namespace dev_DKHP.CoreModule.Const
{
    public class AppConsts
    {
        ...
        public const string USER_DEPID = "USER_DEPID";
        public const string USER_PROFILEPICID = "USER_PROFILEPICID";
    }

    public class AuthStatusConst
    {
        public const string NotApprove = "U";
        public const string Approve = "A";
        public const string Reject = "R ";
        public const string Draft = "E";
